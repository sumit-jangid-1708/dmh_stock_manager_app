              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    AppTextField(
                      controller: orderController.buyerTexAmount,
                      hintText: "Buyer Tex Amount (₹)",
                      prefixIcon: Icons.local_shipping_outlined,
                      keyboardType: const TextInputType.numberWithOptions(
                        decimal: true,
                      ),
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              _buildInfoTag(
                                "Cost: ₹${product.unitPurchasePrice}",
                      ...
                      CustomSearchableDropdown<ProductModel>(
                        ...
                        onChanged: (val) {
                          ...
                          final priceController =
                              item["unitPrice"] as TextEditingController?;
                          if (priceController != null) {
                            priceController.text = val.unitPurchasePrice
                                .toString();
                          }
                        },
                      ),
