...
//   final List<AllocatedBarcode> allocatedBarcodes;
//
//   OrderResponseModel({
//     required this.order,
...
//       order: OrderDetailModel.fromJson(json['order']),
//       allocatedBarcodes: (json['allocated_barcodes'] as List)
//           .map((e) => AllocatedBarcode.fromJson(e))
//           .toList(),
//     );
//   }
// }

// class AllocatedBarcode {
//   final int productId;
//   final int qty;
...
//   });
//
//   factory AllocatedBarcode.fromJson(Map<String, dynamic> json) {
//     return AllocatedBarcode(
