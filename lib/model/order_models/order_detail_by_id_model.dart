...
class OrderBarcodeResponse {
  final int orderId;
  final List<ProductBarcodeGroup> barcodes;
  ...
  factory OrderBarcodeResponse.fromJson(Map<String, dynamic> json) {
    return OrderBarcodeResponse(
      orderId: json['order_id'],
      barcodes: (json['barcodes'] as List)
          .map((e) => ProductBarcodeGroup.fromJson(e))
          .toList(),
    );
  }
}

class ProductBarcodeGroup {
  final int productId;
  final String productName;
  ...
  factory ProductBarcodeGroup.fromJson(Map<String, dynamic> json) {
    return ProductBarcodeGroup(
      productId: json['product_id'],
      productName: json['product_name'] ?? '',
      barcodes: (json['barcodes'] as List)
