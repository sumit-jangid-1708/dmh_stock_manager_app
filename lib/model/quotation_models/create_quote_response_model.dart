...
class CreateQuotationResponseModel {
  final int? id;
  final String? number;
  ...
  factory CreateQuotationResponseModel.fromJson(Map<String, dynamic> json) {
    return CreateQuotationResponseModel(
      id: json['id'],
      number: json['number'],
      ...
      items: (json['items'] as List?)
          ?.map((e) => QuotationItemModel.fromJson(e))
          .toList(),
    );
  }
