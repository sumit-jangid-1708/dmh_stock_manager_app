class AppExceptions implements Exception {
  ...
  String toString() {
    if (_message is Map) {
      // Backend error format: {"message": "Invalid data"}
...
class RequestTimeOut extends AppExceptions {
  RequestTimeOut() : super("Connection timed out. Please try again.");
}

class ServerException extends AppExceptions {
  ServerException() : super("Server is not responding. Please try later.");
}
